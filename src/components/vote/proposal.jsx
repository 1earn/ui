...
class Proposal extends Component {
  ...
  render() {
    ...
    const endTime = currentTime + (blocksTillEnd * 1000 * blockTime)
    const startTime = currentTime - (blocksSinceStart * 1000 * blockTime)

    const yipURL = `https://1ips.1earn.finance/1IPS/yip-${proposal.id}`;
